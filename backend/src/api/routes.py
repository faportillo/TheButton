...
# In development, allow common dev server ports
...
if settings.env == "dev":
    ...
    allowed_origins = [
        ...
        "http://localhost:8080",  # Vue CLI / nginx
        "http://127.0.0.1:5500",
        "http://127.0.0.1:3000",
        "http://127.0.0.1:5173",
        "http://127.0.0.1:8080",
    ...
    # Production: Restrict to your actual frontend domain(s)
    # TODO: Update this with your production frontend URL(s)
    allowed_origins = [
...
def health_check_head():
    """
    HEAD request handler for health check (used by load balancers/health checks).
    ...
    overall_status, _ = aggregate_health(checks)
    status_code = 200 if overall_status == "healthy" else 503
